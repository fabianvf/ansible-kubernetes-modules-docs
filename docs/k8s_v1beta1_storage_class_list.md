...
## k8s_v1beta1_storage_class_list

Kubernetes StorageClassList
...
#### Synopsis
Retrieve a list of storage_class. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
