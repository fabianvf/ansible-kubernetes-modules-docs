## openshift_v1_applied_cluster_resource_quota_list
...
#### Synopsis
Retrieve a list of applied_cluster_resource_quotas. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
