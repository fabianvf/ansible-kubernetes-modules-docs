...
## k8s_v1beta1_stateful_set_list

Kubernetes StatefulSetList
...
#### Synopsis
Retrieve a list of stateful_sets. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
          ...
          contains:
            pod_management_policy:
              ...
              - podManagementPolicy controls how pods are created during initial scale
                ...
                in the opposite order. The alternative policy is `Parallel` which
                will create pods in parallel to match the desired scale without waiting,
            ...
            selector:
              ...
              - selector is a label query over pods that should match the replica
                count. If empty, defaulted to labels on the pod template.
              type: complex
              contains:
                match_expressions:
                  description:
            ...
            service_name:
              ...
              - 'serviceName is the name of the service that governs this StatefulSet.
                ...
                for the network identity of the set. Pods get DNS/hostnames that follow
            ...
            update_strategy:
              ...
              - updateStrategy indicates the StatefulSetUpdateStrategy that will be
                employed to update Pods in the StatefulSet when a revision is made
                to Template.
              type: complex
              contains:
                rolling_update:
            ...
            volume_claim_templates:
              ...
              - volumeClaimTemplates is a list of claims that pods are allowed to
                ...
                volumeMount in one container in the template. A claim in this list
          ...
          contains:
            ...
            observed_generation:
              ...
              - observedGeneration is the most recent generation observed for this
                StatefulSet. It corresponds to the StatefulSet's generation, which
