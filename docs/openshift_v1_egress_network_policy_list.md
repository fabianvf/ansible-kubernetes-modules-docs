...
## openshift_v1_egress_network_policy_list

OpenShift EgressNetworkPolicyList
...
#### Synopsis
Retrieve a list of egress_network_policys. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
