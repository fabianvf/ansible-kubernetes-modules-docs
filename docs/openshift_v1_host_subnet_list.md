## openshift_v1_host_subnet_list

OpenShift HostSubnetList
...
#### Synopsis
Retrieve a list of host_subnets. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
  ...
  contains:
    ...
    items:
      ...
      contains:
        ...
        egress_i_ps:
          description:
          - EgressIPs is the list of automatic egress IP addresses currently hosted
            by this node
          type: list
          contains: str
        host:
          description:
          - Host is the name of the node. (This is the same as the object's name,
            but both fields must be set.)
          type: str
        host_ip:
          description:
