...
## openshift_v1_egress_network_policy
...
#### Synopsis
Manage the lifecycle of a egress_network_policy object. Supports check mode, and attempts to to be idempotent.
...
| spec_egress  |  egress  |   |  | |  egress contains the list of egress policy rules  |
