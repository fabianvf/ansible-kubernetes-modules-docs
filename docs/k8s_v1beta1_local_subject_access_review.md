...
| spec_user  |   |  | |  User is the user you're testing for. If you specify "User" but not "Group", then is it interpreted as "What if User were not a member of any groups  |
...
| spec_group  |   |  | |  Groups is the groups you're testing for.  |
