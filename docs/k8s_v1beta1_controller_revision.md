...
## k8s_v1beta1_controller_revision
...
#### Synopsis
Manage the lifecycle of a controller_revision object. Supports check mode, and attempts to to be idempotent.
...
| data_raw  |     |    | <ul></ul> |  Raw is the underlying serialization of this object.  |
...
| revision  |     |    | <ul></ul> |  Revision indicates the revision of the state represented by Data.  |
