## k8s_v1_pod_template_list

Kubernetes PodTemplateList
...
#### Synopsis
Retrieve a list of pod_templates. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
