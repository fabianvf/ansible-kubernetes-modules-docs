...
#### Synopsis
Manage the lifecycle of a scale object. Supports check mode, and attempts to to be idempotent.
...
| spec_replicas  |  replicas  |   |  | |  desired number of instances for the scaled object.  |
