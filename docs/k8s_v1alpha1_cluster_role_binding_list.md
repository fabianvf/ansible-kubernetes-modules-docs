...
## k8s_v1alpha1_cluster_role_binding_list

Kubernetes ClusterRoleBindingList
...
#### Synopsis
Retrieve a list of cluster_role_bindings. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
