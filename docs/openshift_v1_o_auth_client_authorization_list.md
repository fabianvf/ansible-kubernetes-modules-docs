...
## openshift_v1_o_auth_client_authorization_list

OpenShift OAuthClientAuthorizationList
...
#### Synopsis
Retrieve a list of o_auth_client_authorizations. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
