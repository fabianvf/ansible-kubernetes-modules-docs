...
## k8s_v1beta1_third_party_resource_list

Kubernetes ThirdPartyResourceList
...
#### Synopsis
Retrieve a list of third_party_resources. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
