## k8s_v1beta1_controller_revision_list

Kubernetes ControllerRevisionList
...
#### Synopsis
Retrieve a list of controller_revisions. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
