...
| spec_env_from  |     |    | <ul></ul> |  EnvFrom defines the collection of EnvFromSource to inject into containers.  |
...
| spec_env  |     |    | <ul></ul> |  Env defines the collection of EnvVar to inject into containers.  |
...
| spec_volume_mounts  |     |    | <ul></ul> |  VolumeMounts defines the collection of VolumeMount to inject into containers.  |
...
| spec_volumes  |     |    | <ul></ul> |  Volumes defines the collection of Volume to inject into the pod.  |
