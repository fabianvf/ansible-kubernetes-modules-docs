...
| spec_volume_mounts  |   |  | |  VolumeMounts defines the collection of VolumeMount to inject into containers.  |
...
| spec_volumes  |   |  | |  Volumes defines the collection of Volume to inject into the pod.  |
...
| spec_env_from  |   |  | |  EnvFrom defines the collection of EnvFromSource to inject into containers.  |
...
| spec_env  |   |  | |  Env defines the collection of EnvVar to inject into containers.  |
