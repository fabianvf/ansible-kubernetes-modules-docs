...
## openshift_v1_project_list

OpenShift ProjectList
...
#### Synopsis
Retrieve a list of projects. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
