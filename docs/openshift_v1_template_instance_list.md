...
## openshift_v1_template_instance_list

OpenShift TemplateInstanceList
...
#### Synopsis
Retrieve a list of template_instances. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
