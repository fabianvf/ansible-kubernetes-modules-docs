...
#### Synopsis
Manage the lifecycle of a config_map object. Supports check mode, and attempts to to be idempotent.
...
| data  |     |    | <ul></ul> |  Data contains the configuration data. Each key must consist of alphanumeric characters, '-', '_' or '.'.  |
