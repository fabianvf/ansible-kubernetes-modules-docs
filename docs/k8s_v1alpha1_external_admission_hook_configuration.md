...
## k8s_v1alpha1_external_admission_hook_configuration

Kubernetes ExternalAdmissionHookConfiguration
...
| external_admission_hooks  |     |    | <ul></ul> |  ExternalAdmissionHooks is a list of external admission webhooks and the affected resources and operations.  |
      ...
      contains:
        client_config:
          ...
          contains:
            ...
            service:
              description:
              - Service is a reference to the service for this webhook. If there is
                only one port open for the service, that port will be used. If there
                are multiple ports open, port 443 will be used if it is open, otherwise
                it is an error. Required
              type: complex
              contains:
                name:
                  description:
