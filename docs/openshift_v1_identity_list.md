...
## openshift_v1_identity_list

OpenShift IdentityList
...
#### Synopsis
Retrieve a list of identitys. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
