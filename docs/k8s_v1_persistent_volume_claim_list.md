...
## k8s_v1_persistent_volume_claim_list

Kubernetes PersistentVolumeClaimList
...
#### Synopsis
Retrieve a list of persistent_volume_claims. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
