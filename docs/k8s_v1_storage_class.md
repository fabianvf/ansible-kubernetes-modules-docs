...
#### Synopsis
Manage the lifecycle of a storage_class object. Supports check mode, and attempts to to be idempotent.
...
| parameters  |     |    | <ul></ul> |  Parameters holds the parameters for the provisioner that should create volumes of this storage class.  |
...
| provisioner  |     |    | <ul></ul> |  Provisioner indicates the type of the provisioner.  |
