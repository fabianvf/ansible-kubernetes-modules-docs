...
## openshift_v1_role_binding_restriction_list

OpenShift RoleBindingRestrictionList
...
#### Synopsis
Retrieve a list of role_binding_restrictions. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
