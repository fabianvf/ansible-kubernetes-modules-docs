...
| subjects  |     |    | <ul></ul> |  Subjects holds references to the objects the role applies to.  |
...
| role_ref_api_group  |     |    | <ul></ul> |  APIGroup is the group for the resource being referenced  |
