...
| ------------- |------------- |-------------| ---------|----------- |--------- |
| _from_api_version  |  api_version  |   |  | |  API version of the referent.  |
| _from_field_path  |  field_path  |   |  | |  If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: "spec.containers{name}" (where "name" refers to the name of the container that triggered the event) or if no container name is specified "spec.containers[2]" (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object.  |
| _from_kind  |  kind  |   |  | |  Kind of the referent.  |
| _from_name  |  name  |   |  | |  Name of the referent.  |
| _from_namespace  |  namespace  |   |  | |  Namespace of the referent.  |
| _from_resource_version  |  resource_version  |   |  | |  Specific resourceVersion to which this reference is made, if any.  |
| _from_uid  |  uid  |   |  | |  UID of the referent.  |
...
| binary_as_file  |  as_file  |   |  | |  asFile indicates that the provided binary input should be considered a single file within the build input. For example, specifying "webapp.war" would place the provided binary as `/webapp.war` for the builder. If left empty, the Docker and Source build strategies assume this file is a zip, tar, or tar.gz file and extract it as the source. The custom strategy receives this binary as standard input. This filename may not contain slashes or be '..' or '.'.  |
...
| docker_strategy_options_build_args  |  build_args  |   |  | |  Args contains any build arguments that are to be passed to Docker. See  |
| docker_strategy_options_no_cache  |  no_cache  |   |  | |  noCache overrides the docker-strategy noCache option in the build config  |
...
| revision_git_author_email  |  email  |   |  | |  email of the source control user  |
| revision_git_author_name  |  name  |   |  | |  name of the source control user  |
| revision_git_commit  |  commit  |   |  | |  commit is the commit hash identifying a specific commit  |
| revision_git_committer_email  |  email  |   |  | |  email of the source control user  |
| revision_git_committer_name  |  name  |   |  | |  name of the source control user  |
| revision_git_message  |  message  |   |  | |  message is the description of a specific commit  |
| revision_type  |  type  |   |  | |  type of the build source, may be one of 'Source', 'Dockerfile', 'Binary', or 'Images'  |
| source_strategy_options_incremental  |  incremental  |   |  | |  incremental overrides the source-strategy incremental option in the build config  |
...
| triggered_by_image_api_version  |  api_version  |   |  | |  API version of the referent.  |
| triggered_by_image_field_path  |  field_path  |   |  | |  If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: "spec.containers{name}" (where "name" refers to the name of the container that triggered the event) or if no container name is specified "spec.containers[2]" (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object.  |
| triggered_by_image_kind  |  kind  |   |  | |  Kind of the referent.  |
| triggered_by_image_name  |  name  |   |  | |  Name of the referent.  |
| triggered_by_image_namespace  |  namespace  |   |  | |  Namespace of the referent.  |
| triggered_by_image_resource_version  |  resource_version  |   |  | |  Specific resourceVersion to which this reference is made, if any.  |
| triggered_by_image_uid  |  uid  |   |  | |  UID of the referent.  |
