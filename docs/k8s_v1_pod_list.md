...
#### Synopsis
Retrieve a list of pods. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
          ...
          contains:
            ...
            container_statuses:
              ...
              - The list has one entry per container in the manifest. Each entry is
                currently the output of `docker inspect`.
              type: list
              contains:
                container_id:
                  description:
            ...
            init_container_statuses:
              ...
              - The list has one entry per init container in the manifest. The most
                ...
                recently started container will have startTime set.
              type: list
              contains:
                container_id:
                  description:
