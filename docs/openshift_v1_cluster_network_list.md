...
## openshift_v1_cluster_network_list

OpenShift ClusterNetworkList
...
#### Synopsis
Retrieve a list of cluster_networks. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
      ...
      contains:
        ...
        cluster_networks:
          ...
          - ClusterNetworks is a list of ClusterNetwork objects that defines the global
            ...
            the SDN can allocate addressed from.
          type: list
          contains:
            cidr:
              description:
            ...
            host_subnet_length:
              ...
              - HostSubnetLength is the number of bits of the accompanying CIDR address
                to allocate to each node. eg, 8 would mean that each node would have
                a /24 slice of the overlay network for its pods.
              type: int
        hostsubnetlength:
          description:
