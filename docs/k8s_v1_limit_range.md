...
#### Synopsis
Manage the lifecycle of a limit_range object. Supports check mode, and attempts to to be idempotent.
...
| spec_limits  |  limits  |   |  | |  Limits is the list of LimitRangeItem objects that are enforced.  |
