...
## openshift_v1_o_auth_authorize_token_list

OpenShift OAuthAuthorizeTokenList
...
#### Synopsis
Retrieve a list of o_auth_authorize_tokens. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
