...
## openshift_v1_build_config_list

OpenShift BuildConfigList
...
#### Synopsis
Retrieve a list of build_configs. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
