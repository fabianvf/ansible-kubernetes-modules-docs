...
## k8s_v1alpha1_role_binding_list

Kubernetes RoleBindingList
...
#### Synopsis
Retrieve a list of role_bindings. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
