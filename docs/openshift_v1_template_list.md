## openshift_v1_template_list

OpenShift TemplateList
...
#### Synopsis
Retrieve a list of templates. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
