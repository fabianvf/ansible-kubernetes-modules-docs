...
## k8s_v2alpha1_cron_job_list

Kubernetes CronJobList
...
#### Synopsis
Retrieve a list of cron_jobs. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
                          ...
                          contains:
                            ...
                            node_name:
                              ...
                              - NodeName is a request to schedule this pod onto a
                                specific node. If it is non-empty, the scheduler simply
                                schedules this pod onto that node, assuming that it
                            ...
                            security_context:
                              ...
                              - 'SecurityContext holds pod-level security attributes
                                and common container settings. Optional: Defaults
                                to empty. See type description for default values
                                of each field.'
                              type: complex
                              contains:
                                fs_group:
                                ...
                                run_as_non_root:
                                  ...
                                  - Indicates that the container must run as a non-root
                                    ...
                                    be performed. May also be set in SecurityContext.
                                    If set in both SecurityContext and PodSecurityContext,
                            ...
                            subdomain:
                              ...
                              - If specified, the fully qualified Pod hostname will
                                be "<hostname>.<subdomain>.<pod namespace>.svc.<cluster
                            ...
                            termination_grace_period_seconds:
                              ...
                              - Optional duration in seconds the pod needs to terminate
                                ...
                                grace period will be used instead. The grace period
                                is the duration in seconds after the processes running
                                in the pod are sent a termination signal and the time
                                when the processes are forcibly halted with a kill
                              ...
                              contains:
                                ...
                                key:
                                  ...
                                  - Key is the taint key that the toleration applies
                                    ...
                                    is empty, operator must be Exists; this combination
                                    means to match all values and all keys.
                                  type: str
                                operator:
                                  description:
                                  - Operator represents a key's relationship to the
                                    value. Valid operators are Exists and Equal. Defaults
                                    to Equal. Exists is equivalent to wildcard for
                                    value, so that a pod can tolerate all taints of
                                ...
                                value:
                                  ...
                                  - Value is the taint value the toleration matches
                                    to. If the operator is Exists, the value should
                              ...
                              contains:
                                aws_elastic_block_store:
                                  ...
                                  contains:
                                    fs_type:
                                      description:
                                      - 'Filesystem type of the volume that you want
                                    ...
                                    partition:
                                      ...
                                      - 'The partition in the volume that you want
                                        to mount. If omitted, the default is to mount
                                ...
                                flex_volume:
                                  ...
                                  - FlexVolume represents a generic volume resource
                                    ...
                                    plugin. This is an alpha feature and may change
                                    in future.
                                  type: complex
                                  contains:
                                    driver:
                                    ...
                                    fs_type:
                                      ...
                                      - Filesystem type to mount. Must be a filesystem
                                        type supported by the host operating system.
                                        Ex. "ext4", "xfs", "ntfs". The default filesystem
                                ...
                                flocker:
                                  ...
                                  - Flocker represents a Flocker volume attached to
                                    a kubelet's host machine. This depends on the
                                ...
                                gce_persistent_disk:
                                  ...
                                  contains:
                                    ...
                                    pd_name:
                                      description:
                                      - Unique name of the PD resource in GCE. Used
                                  ...
                                  contains:
                                    directory:
                                      ...
                                      - Target directory name. Must not contain or
                                        start with '..'. If '.' is supplied, the volume
                                ...
                                host_path:
                                  ...
                                  - HostPath represents a pre-existing file or directory
                                    on the host machine that is directly exposed to
                                    the container. This is generally used for system
                                    agents or other privileged things that are allowed
                                  ...
                                  contains:
                                    ...
                                    protection_domain:
                                      ...
                                      - The name of the Protection Domain for the
                                        configured storage (defaults to "default").
                                      type: str
                                    read_only:
                                      description:
                                      - Defaults to false (read/write). ReadOnly here
                                  ...
                                  contains:
                                    ...
                                    volume_namespace:
                                      ...
                                      - VolumeNamespace specifies the scope of the
                                        ...
                                        override the default behaviour. Set to "default"
