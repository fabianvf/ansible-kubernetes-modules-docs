...
| spec_grouprestriction_labels  |     |    | <ul></ul> |  Selectors specifies a list of label selectors over group labels.  |
...
| spec_userrestriction_groups  |     |    | <ul></ul> |  Groups specifies a list of literal group names.  |
...
| spec_serviceaccountrestriction_namespaces  |     |    | <ul></ul> |  Namespaces specifies a list of literal namespace names.  |

| spec_serviceaccountrestriction_serviceaccounts  |     |    | <ul></ul> |  ServiceAccounts specifies a list of literal service-account names.  |
...
| spec_grouprestriction_groups  |     |    | <ul></ul> |  Groups is a list of groups used to match against an individual user's groups. If the user is a member of one of the whitelisted groups, the user is allowed to be bound to a role.  |

| key_file  |     |    | <ul></ul> |  Path to a key file used to authenticate with the API.  |

| api_key  |     |    | <ul></ul> |  Token used to connect to the API.  |

| spec_userrestriction_labels  |     |    | <ul></ul> |  Selectors specifies a list of label selectors over user labels.  |
...
| spec_userrestriction_users  |     |    | <ul></ul> |  Users specifies a list of literal user names.  |
