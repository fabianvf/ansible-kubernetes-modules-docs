...
## openshift_v1_role_binding_restriction

OpenShift RoleBindingRestriction
...
#### Synopsis
Manage the lifecycle of a role_binding_restriction object. Supports check mode, and attempts to to be idempotent.
...
| spec_grouprestriction_groups  |  grouprestriction_groups  |   |  | |  Groups is a list of groups used to match against an individual user's groups. If the user is a member of one of the whitelisted groups, the user is allowed to be bound to a role.  |
| spec_grouprestriction_labels  |  grouprestriction_labels  |   |  | |  Selectors specifies a list of label selectors over group labels.  |
| spec_serviceaccountrestriction_namespaces  |  serviceaccountrestriction_namespaces  |   |  | |  Namespaces specifies a list of literal namespace names.  |
| spec_serviceaccountrestriction_serviceaccounts  |  serviceaccountrestriction_serviceaccounts  |   |  | |  ServiceAccounts specifies a list of literal service-account names.  |
| spec_userrestriction_groups  |  userrestriction_groups  |   |  | |  Groups specifies a list of literal group names.  |
| spec_userrestriction_labels  |  userrestriction_labels  |   |  | |  Selectors specifies a list of label selectors over user labels.  |
| spec_userrestriction_users  |  userrestriction_users  |   |  | |  Users specifies a list of literal user names.  |
