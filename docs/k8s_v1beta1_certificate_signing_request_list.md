...
## k8s_v1beta1_certificate_signing_request_list

Kubernetes CertificateSigningRequestList
...
#### Synopsis
Retrieve a list of certificate_signing_requests. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
