...
## k8s_v1_service_account_list

Kubernetes ServiceAccountList
...
#### Synopsis
Retrieve a list of service_accounts. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
