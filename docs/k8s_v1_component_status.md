...
#### Synopsis
Manage the lifecycle of a component_status object. Supports check mode, and attempts to to be idempotent.
...
| conditions  |     |    | <ul></ul> |  List of component conditions observed  |
