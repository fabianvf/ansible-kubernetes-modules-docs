...
| egress_i_ps  |   |  | |  EgressIPs is the list of automatic egress IP addresses currently hosted by this node  |
...
| host_ip  |   |  | |  HostIP is the IP address to be used as a VTEP by other nodes in the overlay network  |
