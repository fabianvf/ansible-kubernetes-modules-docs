...
## k8s_v1beta1_third_party_resource
...
#### Synopsis
Manage the lifecycle of a third_party_resource object. Supports check mode, and attempts to to be idempotent.
...
| description  |     |    | <ul></ul> |  Description is the description of this object.  |
...
| versions  |     |    | <ul></ul> |  Versions are versions for this third party object  |
