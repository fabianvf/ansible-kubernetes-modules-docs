...
## k8s_v1beta1_pod_security_policy_list

Kubernetes PodSecurityPolicyList
...
#### Synopsis
Retrieve a list of pod_security_policys. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
