## openshift_v1_o_auth_access_token_list

OpenShift OAuthAccessTokenList
...
#### Synopsis
Retrieve a list of o_auth_access_tokens. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
