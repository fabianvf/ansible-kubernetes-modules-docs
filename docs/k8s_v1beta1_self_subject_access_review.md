...
## k8s_v1beta1_self_subject_access_review
...
#### Synopsis
Manage the lifecycle of a self_subject_access_review object. Supports check mode, and attempts to to be idempotent.
