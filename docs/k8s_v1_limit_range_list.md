...
## k8s_v1_limit_range_list

Kubernetes LimitRangeList
...
#### Synopsis
Retrieve a list of limit_ranges. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
