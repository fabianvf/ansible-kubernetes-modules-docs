...
#### Synopsis
Manage the lifecycle of a token_review object. Supports check mode, and attempts to to be idempotent.
...
| spec_token  |  token  |   |  | |  Token is the opaque bearer token.  |
