...
## openshift_v1_broker_template_instance

OpenShift BrokerTemplateInstance
...
#### Synopsis
Manage the lifecycle of a broker_template_instance object. Supports check mode, and attempts to to be idempotent.
...
| spec_binding_i_ds  |  binding_i_ds  |   |  | |  bindingids is a list of 'binding_id's provided during successive bind calls to the template service broker.  |
| spec_secret_api_version  |  secret_api_version  |   |  | |  API version of the referent.  |
| spec_secret_field_path  |  secret_field_path  |   |  | |  If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: "spec.containers{name}" (where "name" refers to the name of the container that triggered the event) or if no container name is specified "spec.containers[2]" (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object.  |
| spec_secret_kind  |  secret_kind  |   |  | |  Kind of the referent.  |
| spec_secret_name  |  secret_name  |   |  | |  Name of the referent.  |
| spec_secret_namespace  |  secret_namespace  |   |  | |  Namespace of the referent.  |
| spec_secret_resource_version  |  secret_resource_version  |   |  | |  Specific resourceVersion to which this reference is made, if any.  |
| spec_secret_uid  |  secret_uid  |   |  | |  UID of the referent.  |
| spec_template_instance_api_version  |  _instance_api_version  |   |  | |  API version of the referent.  |
| spec_template_instance_field_path  |  _instance_field_path  |   |  | |  If referring to a piece of an object instead of an entire object, this string should contain a valid JSON/Go field access statement, such as desiredState.manifest.containers[2]. For example, if the object reference is to a container within a pod, this would take on a value like: "spec.containers{name}" (where "name" refers to the name of the container that triggered the event) or if no container name is specified "spec.containers[2]" (container with index 2 in this pod). This syntax is chosen only to have some well-defined way of referencing a part of an object.  |
| spec_template_instance_kind  |  _instance_kind  |   |  | |  Kind of the referent.  |
| spec_template_instance_name  |  _instance_name  |   |  | |  Name of the referent.  |
| spec_template_instance_namespace  |  _instance_namespace  |   |  | |  Namespace of the referent.  |
| spec_template_instance_resource_version  |  _instance_resource_version  |   |  | |  Specific resourceVersion to which this reference is made, if any.  |
| spec_template_instance_uid  |  _instance_uid  |   |  | |  UID of the referent.  |
  ...
  contains:
    ...
    spec:
      ...
      contains:
        ...
        secret:
          description:
          - secret is a reference to a Secret object residing in a namespace, containing
            the necessary template parameters.
          type: complex
          contains:
            api_version:
              description:
