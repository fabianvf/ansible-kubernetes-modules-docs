...
## k8s_v1beta1_certificate_signing_request
...
#### Synopsis
Manage the lifecycle of a certificate_signing_request object. Supports check mode, and attempts to to be idempotent.
...
| spec_extra  |  extra  |   |  | |  Extra information about the requesting user. See user.Info interface for details.  |
| spec_groups  |  groups  |   |  | |  Group information about the requesting user. See user.Info interface for details.  |
| spec_request  |  request  |   |  | |  Base64-encoded PKCS  |
| spec_uid  |  uid  |   |  | |  UID information about the requesting user. See user.Info interface for details.  |
| spec_usages  |  usages  |   |  | |  allowedUsages specifies a set of usage contexts the key will be valid for. See:  |
| spec_username  |  username  |   |  | |  Information about the requesting user. See user.Info interface for details.  |
