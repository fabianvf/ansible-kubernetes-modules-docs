...
| spec_extra  |     |    | <ul></ul> |  Extra information about the requesting user. See user.Info interface for details.  |

| spec_groups  |     |    | <ul></ul> |  Group information about the requesting user. See user.Info interface for details.  |

| spec_uid  |     |    | <ul></ul> |  UID information about the requesting user. See user.Info interface for details.  |
...
| spec_request  |     |    | <ul></ul> |  Base64-encoded PKCS  |

| spec_username  |     |    | <ul></ul> |  Information about the requesting user. See user.Info interface for details.  |
...
| spec_usages  |     |    | <ul></ul> |  allowedUsages specifies a set of usage contexts the key will be valid for. See:  |
