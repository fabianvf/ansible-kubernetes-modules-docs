...
| spec_extra  |   |  | |  Extra information about the requesting user. See user.Info interface for details.  |

| spec_groups  |   |  | |  Group information about the requesting user. See user.Info interface for details.  |

| spec_uid  |   |  | |  UID information about the requesting user. See user.Info interface for details.  |
...
| spec_request  |   |  | |  Base64-encoded PKCS  |

| spec_username  |   |  | |  Information about the requesting user. See user.Info interface for details.  |
...
| spec_usages  |   |  | |  allowedUsages specifies a set of usage contexts the key will be valid for. See:  |
