...
## openshift_v1_o_auth_client_list

OpenShift OAuthClientList
...
#### Synopsis
Retrieve a list of o_auth_clients. List operations provide a snapshot read of the underlying objects, returning a resource_version representing a consistent version of the listed objects.
