...
| extra  |     |    | <ul></ul> |  Extra holds extra information about this identity  |
...
| provider_user_name  |     |    | <ul></ul> |  ProviderUserName uniquely represents this identity in the scope of the provider  |
...
| provider_name  |     |    | <ul></ul> |  ProviderName is the source of identity information  |
