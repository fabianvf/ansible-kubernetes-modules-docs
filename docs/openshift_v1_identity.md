...
#### Synopsis
Manage the lifecycle of a identity object. Supports check mode, and attempts to to be idempotent.
...
| provider_name  |  |   |  | |  ProviderName is the source of identity information  |
| provider_user_name  |  |   |  | |  ProviderUserName uniquely represents this identity in the scope of the provider  |
