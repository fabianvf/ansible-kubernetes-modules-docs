...
#### Synopsis
Manage the lifecycle of a replica_set object. Supports check mode, and attempts to to be idempotent.
...
| spec_replicas  |  replicas  |   |  | |  Replicas is the number of desired replicas. This is a pointer to distinguish between explicit zero and unspecified. Defaults to 1.  |
